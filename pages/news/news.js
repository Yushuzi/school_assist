...
Page({
  data: {
    ...
    list: [
      ...
      { id: 0, 'type': 'notify', name: '通知',storage:[], url: 'news/notify_list.php', enabled: {guest:false, student:true, teacher:true} },
      { id: 1, 'type': 'news', name: '综合新闻',storage:[], url: 'news/news_list.php', enabled: {guest:true, student:true, teacher:true} },
    ],
    'active': {
      id: 0,
      'type': 'notify',
